...
<?php
	...
	$sql = "SELECT COUNT(*) AS total FROM product WHERE brand={$_GET['brand_id']}";
			...
			<div class="row">
                ...
                <?php
                		...
                		echo '<div class="col-sm-6">';
							...
							if($pagination->has_previous_page()) {
								echo " <li><a href=\"brands.php?brand_id={$_GET['brand_id']}&page=";
							...
							for($i=1; $i <= $pagination->total_pages(); $i++) {
								if($i == $page) {
									...
									echo " <li><a href=\"brands.php?brand_id={$_GET['brand_id']}&page={$i}\">{$i}</a></li> ";
								}
							}
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						...
						<?php $sql = "SELECT * FROM product WHERE status='active' AND brand=" . $_GET['brand_id'] . " LIMIT {$per_page} OFFSET {$pagination->offset()}";
